<template>
  <div>
    ...
    <p>&nbsp;</p>
    <h3>Datenschutzerkl&auml;rung f&uuml;r Cookies</h3>
    ...
    <p>&nbsp;</p>
    <h3>Hinweis betreffend Daten&uuml;bermittlungen in die USA (Vereinigte Staaten von Amerika)</h3>
    <p>Aus Gr&uuml;nden der Vollst&auml;ndigkeit weisen wir Sie darauf hin, dass f&uuml;r Nutzer mit Sitz in der Schweiz &Uuml;berwachungsmassnahmen von US-Beh&ouml;rden bestehen, welche generell die Speicherung aller personenbezogenen Daten aus der Schweiz - welche in die USA &uuml;bermittelt wurden - erm&ouml;glicht.</p>
    <p>Dies geschieht ohne Differenzierung, Einschr&auml;nkung oder Ausnahme anhand der verfolgten Ziele und ohne ein objektives Kriterium, das es erm&ouml;glicht, den Zugang der US-Beh&ouml;rden<!--USA--> zu den Daten und deren sp&auml;tere Nutzung auf ganz bestimmte, strikt begrenzte Zwecke zu beschr&auml;nken, die mit dem Zugang zu diesen Daten als auch mit deren Nutzung verbundenen Eingriffe zu rechtfertigen verm&ouml;gen. Ausserdem weisen wir Sie darauf hin, dass in den USA f&uuml;r die betroffenen Personen aus der Schweiz, keine Rechtsbehelfe vorliegen, die es	erlauben w&uuml;rden, Zugang zu den Sie betreffenden Daten zu erhalten und deren Berichtigung oder L&ouml;schung zu erwirken, resp. kein wirksamer gerichtlicher Rechtsschutz gegen generelle Zugriffsrechte von US-Beh&ouml;rden vorliegt. Wir weisen den Betroffenen explizit auf diese Rechts- und Sachlage hin, um eine entsprechend informierte Entscheidung zur Einwilligung in die Verwendung seiner Daten zu treffen.</p>
    <p>Nutzer mit Wohnsitz in einem Mitgliedstaat der EU<!--EU--> weisen wir darauf hin, dass die USA aus Sicht der Europ&auml;ischen Union nicht &uuml;ber ein ausreichendes Datenschutzniveau verf&uuml;gt.</p>
    <p>&nbsp;</p>
